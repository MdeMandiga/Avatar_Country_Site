...
var albumes = new Array('Thoghts of No Tomorrow', 'Schlacht', 'Avatar', 'Black Waltz', 'Hail the Apocalypse', 'Feathers & Flesh', 'Avatar Country');
var toft = new Array('Bound to the Wall', 'And I Bid You Farewell', 'Last One Standing', 'War Song', 'The Willy', 'My Shining Star', 'My Lie', 'Stranger', 'The Skinner', 'Sane?', 'Slave Hive Meltdown');
var schlacht = new Array('Schlacht', 'Wildflower', 'All Which Is Black', '4 AM Breakdown', 'As It Is', 'All Hail the Queen', 'When Your Darkest Hour Comes', 'I Still Hate You', 'One/One/One/Three', 'Die With Me', 'The End of Our Ride', 'Letters From Neverend');
var avatar = new Array('Queen of Blades', 'The Great Pretende', 'Shattered Wing', 'Reload', 'Out of Our Minds', 'Deeper Down', 'Revolution of Two', 'PigFucker', 'Roadkill', 'Lullaby (Death All Over)');
var black_waltz = new Array('Let Us Die', 'Torn Apart', 'Ready for the Ride', 'In Napalm', 'Black Waltz', 'Blod', 'Let it Burn', 'One Touch', 'Paint Me Red', 'Smells Like a Freakshow', 'Use Your Tongue');
var hail_the_apocalypse = new Array('Hail the Apocalypse', 'What I Dont Know', 'Death of Sound', 'Vultures Fly', 'Bloody Angel', 'Murderer', 'Tsar Bomba', 'Puppet Show', 'Get in Line', 'Something in the Way', 'Tower', 'Use And Abuse');
var feathers_flesh = new Array('Regre', 'House of Eternal Hunt', 'The Eagle Has Landed', 'New Land', 'Tooth, Beak & Claw', 'For the Swarm', 'Fiddlers Farewell', 'One More Hill', 'Black Waters', 'Night Never Ending', 'Pray the Sun Away', 'When the Snow Lies Red', 'Raven Wine', 'Sky Burial', 'I ve Got Something in My Front Pocket for You', 'Det Är Alldeles Försent');
var avatar_country = new Array('Glory to Our King', 'Legend of the King', 'The King Welcomes You to Avatar Country', 'Kings Harvest', 'The King Wants You', 'The King Speaks', 'A Statue of the King', 'King After King', 'Silent Songs of the King Pt. 1: Winter Comes When the King Dreams of Snow', 'Silent Songs of the King Pt. 2: The Kings Palace'); // Index
